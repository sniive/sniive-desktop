...
export const useAppStore = create<AppStore>((set, get) => ({
  ...
  surface: null,
  locale: "fr",
  setInputSourcesDisabled: (disabled) => set({ inputSourcesDisabled: disabled }),
  setRecordButtonDisabled: (disabled) => set({ recordButtonDisabled: disabled }),
  setIsRecording: (isRecording) => {
    if (isRecording) {
      set({ isRecording, inputSourcesDisabled: true, recordButtonDisabled: false })
    } else {
      set({ isRecording })
    }
  },
