...
function AppMain() {
  ...
  return (
    <main className="bg-background w-scren h-screen antialiased rounded-lg flex flex-col items-center overflow-hidden font-sans select-none">
      <header className="w-full grid grid-cols-3 items-center justify-center h-10" data-tauri-drag-region>
        ...
        <div className="flex flex-row items-center justify-center col-span-1" data-tauri-drag-region>
          <RecordButton />
        </div>
